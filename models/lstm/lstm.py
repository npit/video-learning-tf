...
class lstm(Trainable):
    ...
    def define_image_description_validation(self,inputTensor, image_vector_dim, captions_per_item, dataset,settings):
    ...
    def define_image_description(self, inputTensor, composite_dimension, num_words_caption, dataset,
                                 settings):
        with tf.name_scope("LSTM_id") as namescope:
            # num hidden neurons, the size of the hidden state vector
            num_classes = dataset.num_classes
